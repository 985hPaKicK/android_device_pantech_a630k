...
#if 1 //20100202 SKYCAM jjhwang modify
#define CAMERA_EFFECT_OFF 			0  /* This list must match aeecamera.h */
...
#define CAMERA_EFFECT_CONTRAST	12
#define CAMERA_EFFECT_EMBOSS		13
#define CAMERA_EFFECT_SKETCH		14
...
///////////////////////////////////////////////////////////		
 ...
 int32_t scene_mode; 
#endif
#ifdef FEATURE_SKYCAM_FIX_CFG_FOCUS_STEP
 int32_t focus_step;
#endif
...
//#define D_TRACE_FUNCTION
#ifdef D_TRACE_FUNCTION
#define PRINT_FUCTION_IN printk(KERN_INFO "+++ %s IN +++\n", __func__);
#define PRINT_FUCTION_OUT printk(KERN_INFO "=== %s OUT ===\n", __func__);
#else
#define PRINT_FUCTION_IN 
#define PRINT_FUCTION_OUT 
#endif

#define X_PRINT_FUCTION_IN 
#define X_PRINT_FUCTION_OUT 
